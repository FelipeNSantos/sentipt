''' Sentipt - Portuguese Port for the Vader Sentiment Analysis Script
https://github.com/FelipeNSantos/sentipt

Este projeto é um fork do LEIA - Léxico para Inferência Adaptada

Autor: Almeida, Rafael J. A.
https://github.com/rafjaa/LeIA

O LeIA, por sua vez, é um fork do léxico e ferramenta para análise de 
...
root_path = "/home/philos/Downloads/Philos Data/Porfolio/Dev/sentipt/sentipt/"
...
NEGATE = [t.strip() for t in open(root_path+'lexicons/negate.txt')]

# Booster/dampener 'intensifiers' or 'degree adverbs' (Portuguese)
boosters = []
for l in open(root_path+'lexicons/booster.txt'):
    parts = l.strip().split(' ')
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file="/home/philos/Downloads/Philos Data/Porfolio/Dev/sentipt/sentipt/lexicons/vader_lexicon_ptbr.txt", emoji_lexicon="/home/philos/Downloads/Philos Data/Porfolio/Dev/sentipt/sentipt/lexicons/emoji_utf8_lexicon_ptbr.txt"):
